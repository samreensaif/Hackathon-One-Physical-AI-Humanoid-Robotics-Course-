...
const config: Config = {
  ...
  // GitHub Pages
  url: 'https://samreensaif.github.io',
  baseUrl: '/Hackathon-One-Physical-AI-Humanoid-Robotics-Course-/',
  trailingSlash: false,

  // GitHub Pages deployment config.
  organizationName: 'samreensaif',
  projectName: 'Hackathon-One-Physical-AI-Humanoid-Robotics-Course-',
  deploymentBranch: 'gh-pages',

  onBrokenLinks: 'throw',

  // Inject window.CHATBOT_API_URL so the ChatBot widget knows where the
  // FastAPI backend lives. Override this value before deploying to production.
  headTags: [
    {
      tagName: 'script',
